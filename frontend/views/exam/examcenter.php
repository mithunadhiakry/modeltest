...
<div class="container">
	<div class="row">
		<div class="row">
														...
														<div class="row">
															<div class="col-md-3 padding-right-0">
																...
																<ul class="nav nav-pills nav-stacked" id="exam_selection_left_tab">
																	<li class="paid_exam">Practice Exam</li>
																   	<?php
																   	$show_paid_exam = 1;
																   		if(isset($category_list_r)){
																   			foreach($category_list_r as $category_list){
																   				...
																   				if($category_list->id == 60 || $category_list->id == 59){
																   					if($show_paid_exam == 1){
																   	?>
																   					<li class="paid_exam">Special Exam</li>
																   					<?php $show_paid_exam++; }  ?>
																				...
																				<div class="tab-pane <?php if($category_no == 1)echo 'active'; ?>" id="category_selection<?=$category_list->id;?>">
																					...
																					<div class="exam_container_all">
																						<?php
																							...
																							}else if($category_list->id == '57' || $category_list->id =='58'){
																								
																								$get_sub_category_r = Category::get_sub_category($category_list->id);
																								echo Yii::$app->controller->renderPartial('_exam_centre_admission_job',[
																																			'get_sub_category_r'=>$get_sub_category_r,
																																			'category_list' => $category_list,
																																			'chapter_list_session' => $chapter_list_session
																																		]);
								...
								?>
									...
									<li class="selected_item<?= $chapter_data->id; ?>">
										...
										<span class="remove remove_selected_chapter" data-selected-id="<?= $chapter_data->id; ?>">
											<img alt="Remove" src="<?= Url::base('') ?>/images/cross_1.png">
										</span>
									</li>
			...
			<?php if(!empty($get_institution_list_r)){ ?>
								...
								?>
											<div class="col-md-2 ">
										    	<div class="row">
										    		...
										    		?>
															<img alt="Institution" src="<?= Url::base('') ?>/institution/user_img/<?= $get_institution_list->image; ?>">
										    		<?php }else{ ?>
															<img alt="Institution" src="<?= Url::base('') ?>/institution/user_img/institution_profile.png">
										    		<?php }	?>
...
<div class="modal fade" id="instruction_modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal fade" id="instruction_modal_model_test" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
...
<div class="modal fade" id="instruction_modal_previous_year_test" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
