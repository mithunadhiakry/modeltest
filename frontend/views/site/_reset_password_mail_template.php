<table cellpadding="10" style="width:100%;background-color: rgb(238,242,245);font-family:'segoeui','arial'">
	...
	<tr align="center" style="border:1px solid rgba(0,0,0,.1);background: #fff none repeat scroll 0 0;float: left;font-size: 15px;margin: 1%;width: 98%;">
		<td colspan="2" style="padding:50px 100px;color:rgb(105,103,104);">
			<span style="float: left;font-size: 24px;margin-bottom: 12px;text-align: center;width: 100%;">
				Hello <?= $model->name;?></span> <br/>
				To re-setting your password,<br/>
				please, click on the <strong>Reset Password</strong> button below.				
		</td>
	</tr>

	<tr align="center">
		<td style="padding-bottom: 40px;padding-top: 20px;">
			<a style="background: rgb(204, 33, 41) none repeat scroll 0 0;color: #fff;padding: 10px 100px;text-decoration: none;" href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/site/reset_password','token'=>$model->password_reset_token])?>">Click Here</a>
		</td>
	</tr>
