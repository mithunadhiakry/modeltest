                                    ...
                                    <ul class="main_menu inner-menu">
                                        <li>
                                            <?php
                                                if(isset(Yii::$app->user->identity) && Yii::$app->user->identity->user_type == 'student'){
                                            ?>
                                                <a href="<?= Url::toRoute(['dashboard/index']); ?>"><i class="fa fa-home"></i></a>
                                            <?php }else{ ?>
                                                <a href="<?= Url::toRoute(['site/index']); ?>"><i class="fa fa-home"></i></a>
                                            <?php } ?>
                                        </li>
                                        ...
                                        ?>
                                                ...
                                                <li>
                                                    <a href="<?= Url::toRoute(['user/account']); ?>">Account</a>
                                                </li>
                                                <li>
