...
$this->title = 'Invoice of - '.$invoice_no;


$net_price = $package->price_bd * $package->duration/30;

if(!empty($membership_model->discounts_code)){
	$discounts_data = Discounts::find()->where(['discounts_code' => $membership_model->discounts_code])->one();
}
...
<div class="membershiprequest-create">
	<div class="col-md-12">
		<div class="pane">
			...
			<table cellpadding="10" style="width:100%;">
				...
				<tr >
					<td colspan="2" style="padding-top:40px;padding-bottom:40px;">
						...
						<strong>Date:</strong> <?php echo $membership_model->timestamp; ?>
					</td>
			...
			<table cellpadding="10" class="invoice_table" style="width:100%;background-color: rgb(238,242,245);font-family:'segoeui','arial'">
					<tr>
						<td>Points</td>
						<td>Duration</td>
						<td>Share exam</td>
					...
					<?php
						if(!empty($discounts_data) && $discounts_data->discounts_type == 'Free Points'){
					?>
							<tr>
								<td colspan="5" style="text-align:right;padding-right:15px;padding-bottom:0px;">
									Discount: 
		...
		<a href="#" class="download_invoice">download</a>
	</div>
</div>
