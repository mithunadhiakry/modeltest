<table cellpadding="10" style="width:100%;background-color: rgb(238,242,245);font-family:'segoeui','arial'">
	...
	<tr align="center" style="border:1px solid rgba(0,0,0,.1);background: #fff none repeat scroll 0 0;float: left;font-size: 15px;margin: 1%;width: 98%;">
		<td colspan="2" style="padding:50px 100px;color:rgb(105,103,104);line-height:25px;">
			<span style="float: left;font-size: 22px;margin-bottom: 12px;text-align: center;text-transform: uppercase;width: 100%;">Hello <?= $signup_model->name;?> .. !</span> <br/>
				Congratulations! Now you are an official member of this website. As a token of our appreciation, we would like to ask you to complete your full profile; so that we can give you, 30 Points FREE to use that your own way.
				<br/><br/> Please click here to conform your membership.
		</td>
	</tr>
