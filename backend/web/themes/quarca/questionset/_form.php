    ...
    <div class="questionset-form">
        ...
        <div class="pane" style="float:left; width:100%; margin-top:0;">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <br/>
                    <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-success questionset_submit' : 'btn btn-primary questionset_submit']) ?>
                </div>
            </div>
        </div>
...
<?php
    ...
    $this->registerJs("
        ...
        $('.questionset_submit').on('click', function(){
            var newValue = 0;
            $('.checking_question').each(function() {
               
                if($(this).val() > 0){

                    var newdata = parseInt($(this).val());
            ...
            if(newValue > 180){
                ...
                BootstrapDialog.alert({
                     title: 'WARNING',
                     'message': 'You are not allowed to take more than 180 questions.'
                });
    ...
    ", yii\web\View::POS_END, "questionset_submit");
