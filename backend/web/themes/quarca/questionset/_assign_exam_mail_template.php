	...
	<tr align="center" style="border:1px solid rgba(0,0,0,.1);background: #fff none repeat scroll 0 0;float: left;font-size: 15px;margin: 1%;width: 98%;">
		<td colspan="2" style="padding:50px 100px;color:rgb(105,103,104);line-height:25px;">
			<span style="float: left;font-size: 24px;margin-bottom: 12px;text-align: center;width: 100%;">
				An Exam Invitation from Model Test Administrator				
			</span><br/><br/><br/><br/> 
			<span style="float: left;font-size: 20px;margin-bottom: 12px;text-align: left;width: 100%;">
				Hello there,<br/><br/>
				Model Test Administrator has just assigned an exam in <strong>model-test.com</strong>.
				If you are a member of this site,please go to your Dashboard and find
